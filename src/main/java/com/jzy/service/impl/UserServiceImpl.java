...
import com.jzy.util.user.UserRedis;
...
public class UserServiceImpl extends BaseServiceImpl implements UserService {
    ...
    public User selectUserByNameAndPassword(String userName, String userPassword) {
        ...
        final String baseKey = UserRedis.KEY_USER_LOGIN_NAMEANDPASSWORD;
    ...
    public User updateUserSession(HttpSession session) {
        ...
        String userId = ((User) session.getAttribute(UserSession.USER_INFO_SESSION)).getUserId();
        User user = this.selectUserById(userId);
        session.setAttribute(UserSession.USER_INFO_SESSION, user);
        return user;
    }
    ...
    public void deleteUserSession(HttpSession session) {
        session.removeAttribute(UserSession.USER_INFO_SESSION);
    }
