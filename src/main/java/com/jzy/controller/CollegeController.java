...
import com.jzy.util.college.CollegeModel;
...
public class CollegeController extends BaseController{
     ...
     * @return com.jzy.dto.other.ResultMap<java.util.List<com.jzy.dto.college.CollegeDto>>
     **/
    ...
    public String collegeEdit(Model model, CollegeDto collegeDto) {
        model.addAttribute(CollegeModel.COLLEGE_ALL_INFO_MODEL, collegeDto);
