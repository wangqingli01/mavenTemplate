...
public class UserController extends BaseController {
    ...
    public String info(Model model) {
        ...
        model.addAttribute(UserModel.USER_MODEL, user);
        model.addAttribute(UserModel.USER_ELSE_IDENTITY_MODEL, userService.findElseIdentityList(user.getUserIdentity()));
