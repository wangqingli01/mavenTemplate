...
import com.jzy.util.clazz.ClassModel;
...
public class ClassController extends BaseController {
    ...
    /**
     * @return com.jzy.dto.other.ResultMap<java.util.List   <   com.jzy.dto.clazz.ClassWithGradeMajorCollegeDto>>
     * @author JinZhiyun
    ...
    @ResponseBody
    public ResultMap<List<ClassWithGradeMajorCollegeDto>> showAllClassInfo(MyPage myPage, ClassSearchDto classSearch) {
    ...
    public String classEdit(Model model, ClassWithGradeMajorCollegeDto classWGMC) {
        model.addAttribute(ClassModel.CLASS_ALL_INFO_MODEL, classWGMC);
