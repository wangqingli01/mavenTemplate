...
import com.jzy.util.teacher.TeacherModel;
...
public class TeacherController extends BaseController {
     ...
     * @return com.jzy.dto.other.ResultMap<java.util.List<com.jzy.dto.teacher.TeacherWithTitleMajorCollegeDto>>
     **/
    ...
    public String teaEdit(Model model, TeacherWithTitleMajorCollegeDto teaWTMC) {
        model.addAttribute(TeacherModel.TEACHER_ALL_INFO_MODEL, teaWTMC);
    ...
    public String teaInfo(Model model, @RequestParam(value = "teaNum", required = false) String teaNum) {
        ...
        model.addAttribute(TeacherModel.TEACHER_MODEL, teaWTMC);
