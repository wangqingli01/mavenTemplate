...
import com.jzy.dto.other.ResultMap;
...
import com.jzy.util.student.StudentModel;
import com.jzy.util.student.StudentUtil;
import com.jzy.util.user.UserSession;
...
public class StudentController extends BaseController{
     ...
     * @return com.jzy.dto.other.ResultMap<java.util.List<com.jzy.dto.student.StudentSearchDto>>
     **/
     ...
     * @Param [myPage]
     * @return com.jzy.dto.other.ResultMap<java.util.List<com.jzy.dto.student.StudentWithGradeClassMajorCollegeDto>>
     **/
    @RequestMapping("/myOwnInfo")
    @ResponseBody
    public ResultMap<List<StudentWithGradeClassMajorCollegeDto>> myOwnInfo(MyPage myPage) {
        User user = (User) session.getAttribute(UserSession.USER_INFO_SESSION);
    ...
    public String stuEdit(Model model, StudentWithGradeClassMajorCollegeDto stuWGCMC) {
        model.addAttribute(StudentModel.STUDENT_ALL_INFO_MODEL, stuWGCMC);
    ...
    public String stuInfo(Model model, @RequestParam(value = "stuNum", required = false) String stuNum) {
        ...
        model.addAttribute(StudentModel.STUDENT_MODEL, stuWGCMC);
