...
import com.jzy.util.major.MajorModel;
...
public class MajorController extends BaseController {
    ...
    /**
     * @return com.jzy.dto.other.ResultMap<java.util.List   <   com.jzy.dto.major.MajorWithCollegeDto>>
     * @author JinZhiyun
    ...
    public String majorEdit(Model model, MajorWithCollegeDto majorWC) {
        model.addAttribute(MajorModel.MAJOR_ALL_INFO_MODEL, majorWC);
