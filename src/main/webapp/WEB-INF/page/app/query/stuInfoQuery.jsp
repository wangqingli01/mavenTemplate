    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'stuNation', title: '民族', sort: true}
                , {field: 'stuStatus', title: '学籍状态', sort: true}
                , {field: 'stuSchoolName', title: '计算机基础', sort: true}
                , {field: 'stuIDNumber', title: '思修', sort: true}
                , {field: 'stuLength', title: '毛概', sort: true}
                /* , {field: 'stuGradation', title: '层次', sort: true} */
                , {field: 'stuDegreeCategory', title: '英语', sort: true}
                , {field: 'stuDegreeForm', title: '高数', sort: true}
               /*  , {field: 'stuEnrollmentDate',title: '入学日期',templet: '<div>{{ layui.laytpl.toDateString(d.stuEnrollmentDate) }}</div>', sort: true}
                , {field: 'stuEstimatedDate', title: '预计毕业日期',templet: '<div>{{ layui.laytpl.toDateString(d.stuEstimatedDate) }}</div>', sort: true} */
